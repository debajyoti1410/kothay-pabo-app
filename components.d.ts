...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    NoRecordFound: typeof import('./resources/js/components/NoRecordFound.vue')['default']
    Notifications: typeof import('./resources/js/@core/components/Notifications.vue')['default']
    PageLoader: typeof import('./resources/js/components/PageLoader.vue')['default']
    PageTitle: typeof import('./resources/js/components/PageTitle.vue')['default']
